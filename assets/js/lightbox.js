document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelectorAll("img:not(#lightbox-img):not(.no-lightbox)")
    .forEach((img) => {
      ...
      img.addEventListener("click", () => {
        ...
        if (lightboxNextBtn) {
          ...
          if (
            galleryFrame &&
            galleryFrame.querySelectorAll(".gallery-img").length > 1
          ) {
            ...
            if (prevH2 && prevH2.tagName === "H2") {
              ...
              currentGalleryBtnNext = null;
              currentGalleryBtnPrev = null;
            }
          } else {
            lightboxToggleGroup.style.display = "none";
            currentGalleryBtnNext = null;
            currentGalleryBtnPrev = null;
          }
        }
  ...
  function handleLightboxNav(btn, e) {
  ...
  if (lightboxNextBtn) {
    lightboxNextBtn.addEventListener("click", (e) =>
      handleLightboxNav(currentGalleryBtnNext, e),
    );
  }
  if (lightboxPrevBtn) {
    lightboxPrevBtn.addEventListener("click", (e) =>
      handleLightboxNav(currentGalleryBtnPrev, e),
    );
  }
